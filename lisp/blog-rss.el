;;; blog-rss.el --- description -*- lexical-binding: t; -*-
;;
...
;; Version: 0.0.1
;; Keywords:
;; Homepage: https://github.com/brown/blog-rss
...
(defcustom org-rss-indent-feed nil
  "Indent the generated RSS feed?"
  :group 'org-export-rss
  :type 'boolean)

(defcustom org-rss-posts-url nil
  "The base URL for all the items in the feed."
  :group 'org-export-rss
  :type 'string)

(defcustom org-rss-include-post-content nil
  "Include each post's content in the feed?"
  :group 'org-export-rss
  :type 'boolean)
...
(org-export-define-derived-backend 'rss 'html
  ...
  '((:description "DESCRIPTION" nil nil newline)
    ...
    (:rss-posts-url "RSS_POSTS_URL" nil nil org-rss-posts-url)
  ...
  (if (> (org-export-get-relative-level headline info) 1)
    ...
    (unless (org-element-property :footnote-section-p headline)
      (let* ((email (org-export-data (plist-get info :email) info))
             ...
             (publink
              (concat (file-name-as-directory (plist-get info :rss-posts-url))
                      hl-perm))
  ...
  (cond ((not (directory-name-p entry))
         (let* ((file (org-publish--expand-file-name entry project))
           ...
           (with-temp-buffer
             ...
             (when org-rss-include-post-content
...
`org-list-to-lisp'.  PROJECT is the current project."
  (concat "#+TITLE: " title "\n"
          "#+RSS_POSTS_URL: " org-rss-posts-url "\n\n"
